                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label> <?php echo app('translator')->get('Site Country Code'); ?></label>
                                    <input type="text" class="form-control" name="country_code" value="<?php echo e($general->country_code); ?>"/>
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\kerfapt.ddhotel.in\core\resources\views/admin/setting/general.blade.php ENDPATH**/ ?>